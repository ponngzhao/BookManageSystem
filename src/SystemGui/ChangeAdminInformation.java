...
public class ChangeAdminInformation extends JFrame {
    ...
    public ChangeAdminInformation(int userID) {
        super("更改个人信息");
        this.userID = userID;
        ...
        try {
            ResultSet rs = dataBaseOperate.getAdminInformation(userID);
            rs.next();
        ...
        try {
            ResultSet rs = dataBaseOperate.getAdminInformation(userID);
            rs.next();
            credentials = rs.getString("A_Credentials");
        }catch (Exception e){
            e.printStackTrace();
        }
        ...
        try {
            ResultSet rs = dataBaseOperate.getAdminInformation(userID);
            rs.next();
            credentialsIDTextField.setText(rs.getString("A_CredentialsID"));
        }catch (Exception e){
            e.printStackTrace();
        }
        ...
        try {
            ResultSet rs = dataBaseOperate.getAdminInformation(userID);
            rs.next();
            phoneNumberTextField.setText(rs.getString("A_PhoneNumber"));
        }catch (Exception e){
            e.printStackTrace();
        }
        ...
        try {
            ResultSet rs = dataBaseOperate.getAdminInformation(userID);
            rs.next();
            emailTextField.setText(rs.getString("A_Email"));
        }catch (Exception e){
            e.printStackTrace();
        }
        ...
        yesButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                dataBaseOperate.changeAdminInformationUp(userID,name,sex,type,year+"-"+month+"-"+day,credentials,
